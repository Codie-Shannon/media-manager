...
namespace MediaControlsLibrary
{
    ...
    /// </summary>
    public partial class imgPicture : ContentControl, IScrollInfo
    {
        ...
        // This interface works with the ScrollViewer such that when imgPicture is 
        // wrapped (in XAML) with a ScrollViewer the IScrollInfo interface allows the imgPicture to
        // handle the the scrollbar offsets.
        //
        // The IScrollInfo properties and member functions are implemented in imgPicture_IScrollInfo.cs.
        //
        ...
        /// <summary>
        /// Reference to the ScrollViewer that is wrapped (in XAML) around the imgPicture.
        ...
        public static readonly DependencyProperty ContentScaleProperty =
                DependencyProperty.Register("ContentScale", typeof(double), typeof(imgPicture),
        ...
        public static readonly DependencyProperty MinContentScaleProperty =
                DependencyProperty.Register("MinContentScale", typeof(double), typeof(imgPicture),
        ...
        public static readonly DependencyProperty MaxContentScaleProperty =
                DependencyProperty.Register("MaxContentScale", typeof(double), typeof(imgPicture),
        ...
        public static readonly DependencyProperty ContentOffsetXProperty =
                DependencyProperty.Register("ContentOffsetX", typeof(double), typeof(imgPicture),
        ...
        public static readonly DependencyProperty ContentOffsetYProperty =
                DependencyProperty.Register("ContentOffsetY", typeof(double), typeof(imgPicture),
                                            new FrameworkPropertyMetadata(0.0, ContentOffsetY_PropertyChanged, ContentOffsetY_Coerce));

        public static readonly DependencyProperty AnimationDurationProperty =
                DependencyProperty.Register("AnimationDuration", typeof(double), typeof(imgPicture),
                                            new FrameworkPropertyMetadata(0.4));

        public static readonly DependencyProperty ContentZoomFocusXProperty =
                DependencyProperty.Register("ContentZoomFocusX", typeof(double), typeof(imgPicture),
                                            new FrameworkPropertyMetadata(0.0));

        public static readonly DependencyProperty ContentZoomFocusYProperty =
                DependencyProperty.Register("ContentZoomFocusY", typeof(double), typeof(imgPicture),
                                            new FrameworkPropertyMetadata(0.0));

        public static readonly DependencyProperty ViewportZoomFocusXProperty =
                DependencyProperty.Register("ViewportZoomFocusX", typeof(double), typeof(imgPicture),
                                            new FrameworkPropertyMetadata(0.0));

        public static readonly DependencyProperty ViewportZoomFocusYProperty =
                DependencyProperty.Register("ViewportZoomFocusY", typeof(double), typeof(imgPicture),
                                            new FrameworkPropertyMetadata(0.0));

        public static readonly DependencyProperty ContentViewportWidthProperty =
                DependencyProperty.Register("ContentViewportWidth", typeof(double), typeof(imgPicture),
                                            new FrameworkPropertyMetadata(0.0));

        public static readonly DependencyProperty ContentViewportHeightProperty =
                DependencyProperty.Register("ContentViewportHeight", typeof(double), typeof(imgPicture),
                                            new FrameworkPropertyMetadata(0.0));

        public static readonly DependencyProperty IsMouseWheelScrollingEnabledProperty =
                DependencyProperty.Register("IsMouseWheelScrollingEnabled", typeof(bool), typeof(imgPicture),
        ...
        {
            imgPictureAnimationHelper.CancelAnimation(this, ContentOffsetXProperty);
            imgPictureAnimationHelper.CancelAnimation(this, ContentOffsetYProperty);
        ...
        public void AnimatedSnapTo(Point contentPoint)
        {
            ...
            imgPictureAnimationHelper.StartAnimation(this, ContentOffsetXProperty, newX, AnimationDuration);
            imgPictureAnimationHelper.StartAnimation(this, ContentOffsetYProperty, newY, AnimationDuration);
        }
        ...
        public void AnimatedZoomAboutPoint(double newContentScale, Point contentZoomFocus)
        {
            ...
            imgPictureAnimationHelper.CancelAnimation(this, ContentZoomFocusXProperty);
            imgPictureAnimationHelper.CancelAnimation(this, ContentZoomFocusYProperty);
            imgPictureAnimationHelper.CancelAnimation(this, ViewportZoomFocusXProperty);
            imgPictureAnimationHelper.CancelAnimation(this, ViewportZoomFocusYProperty);
            ...
            imgPictureAnimationHelper.StartAnimation(this, ContentScaleProperty, newContentScale, AnimationDuration,
                delegate (object sender, EventArgs e)
                {
        ...
        public void ZoomAboutPoint(double newContentScale, Point contentZoomFocus)
        {
            ...
            imgPictureAnimationHelper.CancelAnimation(this, ContentScaleProperty);
            imgPictureAnimationHelper.CancelAnimation(this, ContentOffsetXProperty);
            imgPictureAnimationHelper.CancelAnimation(this, ContentOffsetYProperty);
        ...
        public void AnimatedScaleToFit()
        {
            if (content == null)
            {
                throw new ApplicationException("PART_Content was not found in the imgPicture visual template!");
            }
        ...
        static imgPicture()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(imgPicture), new FrameworkPropertyMetadata(typeof(imgPicture)));
        }
        ...
        private void AnimatedZoomPointToViewportCenter(double newContentScale, Point contentZoomFocus, EventHandler callback)
        {
            ...
            imgPictureAnimationHelper.StartAnimation(this, ViewportZoomFocusXProperty, ViewportWidth / 2, AnimationDuration);
            imgPictureAnimationHelper.StartAnimation(this, ViewportZoomFocusYProperty, ViewportHeight / 2, AnimationDuration);
        }
